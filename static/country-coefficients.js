...
let forrigeUkeData = [
	["ENG", 17.375, 1, 1, 1, 2, 3, 3],
	["ESP", 15.437, 3, 3, 4, 4, 4, 5],
	["ITA", 19.857, 2, 2, 2, 1, 1, 1],
	["GER", 18.642, 4, 4, 3, 3, 2, 2],
	["NED", 10.000, 6, 6, 6, 7, 8, 11],
	["FRA", 16.250, 5, 5, 5, 5, 5, 4],
	["POR", 11.000, 7, 7, 7, 8, 9, 9],
	["BEL", 14.200, 8, 8, 8, 6, 6, 6],
	["TUR", 12.000, 9, 9, 9, 9, 10, 8],
	["SCO", 6.400, 11, 14, 18, 17, 15, 16],
	["AUT", 4.800, 13, 12, 15, 19, 17, 21],
	["SUI", 5.200, 12, 15, 13, 15, 20, 19],
	["CZE", 13.500, 10, 10, 10, 10, 7, 7],
	...
	["GRE", 10.400, 17, 17, 16, 16, 11, 10],
	["POL", 6.875, 21, 18, 17, 12, 16, 15],
	["CRO", 5.875, 20, 20, 20, 24, 18, 17],
	["RUS", 4.333, 22, 22, 24, 27, 24, 24],
	["CYP", 3.750, 23, 24, 27, 26, 28, 28],
	["SWE", 1.875, 25, 28, 25, 28, 38, 38],
	["ROU", 3.250, 26, 29, 29, 23, 29, 29],
	["HUN", 4.500, 24, 23, 26, 20, 22, 22],
	["SVK", 5.000, 29, 26, 21, 18, 21, 20],
	["BUL", 4.375, 27, 27, 28, 25, 23, 23],
	["AZE", 5.875, 28, 25, 22, 21, 18, 17],
	["MDA", 2.000, 31, 30, 30, 34, 37, 37],
	["SVN", 3.875, 30, 31, 31, 32, 26, 26],
	["KVX", 3.000, 32, 32, 33, 33, 31, 31],
	["KAZ", 3.125, 33, 39, 36, 40, 30, 30],
	["IRL", 1.500, 35, 33, 35, 36, 43, 43],
	["FIN", 1.750, 34, 34, 34, 38, 39, 39],
	["ARM", 2.250, 36, 40, 40, 37, 33, 33],
	["LVA", 1.625, 37, 38, 37, 39, 42, 42],
	["FRO", 2.750, 38, 35, 39, 35, 32, 32],
	...
	["MKD", 1.500, 50, 48, 49, 45, 43, 43],
	["AND", 1.666, 51, 52, 48, 51, 41, 41],
        ...
        if (forrigeUkeData[j][0] == ranking_array[i][0]) {
          if (2+(aar_etter_forste_periode+22-denne_sesongen) < 2) {
            rangeringEndring = "";
						...
						if (2+(aar_etter_forste_periode+22-denne_sesongen) >= 7) {
							klatring = 0;
						}
            if (klatring == 0) {
              rangeringEndring = "";
...
id = "dropDownMeny";
for (i = 0; i < nyligste_poeng_rangering[0] - 20 + 6; i++) {
