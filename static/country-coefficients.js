...
let forrigeUkeData = [
	["ENG", 14.625, 1, 1, 1, 2, 3],
	["ESP", 13.437, 2, 3, 4, 4, 5],
	["ITA", 16.571, 3, 2, 2, 1, 1],
	["GER", 15.500, 4, 4, 3, 3, 2],
	["NED", 10.000, 6, 6, 6, 7, 10],
	["FRA", 14.416, 5, 5, 5, 5, 4],
	["POR", 10.166, 7, 7, 7, 9, 9],
	["BEL", 12.400, 8, 8, 8, 6, 7],
	["TUR", 11.500, 9, 9, 9, 8, 8],
	["SCO", 6.400, 10, 16, 18, 19, 16],
	["AUT", 4.600, 13, 13, 15, 22, 21],
	["SUI", 5.000, 12, 14, 14, 15, 19],
	["CZE", 13.000, 11, 10, 10, 10, 6],
	["DEN", 8.500, 15, 15, 11, 13, 12],
	["NOR", 8.000, 14, 12, 13, 14, 14],
	["SRB", 1.400, 19, 19, 19, 31, 46],
	["UKR", 4.100, 18, 21, 23, 21, 25],
	["ISR", 8.500, 16, 11, 12, 11, 12],
	["GRE", 8.600, 17, 17, 17, 17, 11],
	["POL", 6.875, 21, 18, 16, 12, 15],
	["CRO", 5.875, 20, 20, 20, 24, 17],
	["RUS", 4.333, 22, 22, 24, 27, 24],
	["CYP", 3.750, 23, 24, 27, 26, 28],
	["SWE", 1.875, 25, 28, 25, 28, 38],
	["ROU", 3.250, 26, 29, 29, 23, 29],
	["HUN", 4.500, 24, 23, 26, 18, 22],
	["SVK", 5.000, 29, 26, 21, 16, 19],
	["BUL", 4.375, 27, 27, 28, 25, 23],
	["AZE", 5.875, 28, 25, 22, 20, 17],
	["MDA", 2.000, 31, 30, 30, 34, 37],
	["SVN", 3.875, 30, 31, 31, 32, 26],
	["KVX", 3.000, 32, 32, 33, 33, 31],
	["KAZ", 3.125, 33, 39, 36, 40, 30],
	["IRL", 1.500, 35, 33, 35, 36, 43],
	["FIN", 1.750, 34, 34, 34, 38, 39],
	["ARM", 2.250, 36, 40, 40, 37, 33],
	["LVA", 1.625, 37, 38, 37, 39, 42],
	["FRO", 2.750, 38, 35, 39, 35, 32],
	["LIE", 0.500, 40, 42, 38, 29, 52],
	["BIH", 2.250, 39, 37, 42, 41, 33],
	["ISL", 3.833, 41, 36, 32, 30, 27],
...
function byggTabell_test(ranking_array, aar_etter_forste_periode, column, order) {
  ...
  for (i = 0; i < ranking_array.length; i++) {
    ...
    let internt_oppgjør = "";
    // Brukes dersom land har internt oppgjør og er garantert koeffisientpoeng.
    // if (['ENG','ESP','ITA','GER','POR','BEL','GRE','CZE','ISR'].includes(ranking_array[i][0]) && aar_etter_forste_periode >= internt_oppgjor_aar && aar_etter_forste_periode <= internt_oppgjor_aar+4) {
  ...
  if (internt_oppgjør_bool) {
    if (aar_etter_forste_periode == internt_oppgjor_aar) {
      document.getElementById("internt_oppgjør_asterisk").innerText = "*Includes guaranteed coefficient points from future internal match for this country. Consequently, the club count is reduced by one."
    }
    else {
      document.getElementById("internt_oppgjør_asterisk").innerText = "*Includes guaranteed coefficient points from future internal match for this country."
    }
  }
  else {
