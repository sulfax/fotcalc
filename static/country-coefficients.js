...
function byggTabell_test(ranking_array, aar_etter_forste_periode) {
  ...
  for (i = 0; i < ranking_array.length; i++) {
    ...
    if (ranking_array[i][0] == 'NIR') {
      flagg_ikon = '<div class="flagg_div"><img id="NIR" src="media/UEFA/' + ranking_array[i][0] + '.svg"></div>'
      land = "Northern Ireland"
    }
    else {
      flagg_ikon = '<div class="flagg_div"><img src="media/UEFA/' + ranking_array[i][0] + '.svg"></div>'
