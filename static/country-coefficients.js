...
// Funksjonen som utfører den jevne rullingen
...
// Lytter etter klikk på lenker med class "smooth-scroll"
...
links.forEach(link => {
	link.addEventListener('click', function(e) {
			...
			smoothScroll(targetId, 1000); // 1000ms = 1 sekund (juster etter behov)
	});
});
