...
let forrigeUkeData = [
  ...
  ["ESP", 8.687, 2, 3, 3, 4, 4],
  ["ITA", 9.142, 3, 2, 2, 1, 2],
  ["GER", 10.071, 4, 4, 4, 3, 1],
  ["NED", 6.200, 5, 5, 5, 7, 10],
  ["FRA", 6.916, 6, 6, 6, 8, 8],
  ["POR", 5.166, 7, 7, 7, 9, 14],
  ["BEL", 8.600, 8, 8, 8, 5, 5],
  ["TUR", 8.750, 9, 9, 9, 6, 3],
  ["SCO", 3.600, 10, 16, 19, 27, 20],
  ["AUT", 3.600, 11, 11, 13, 23, 20],
  ["SUI", 3.400, 12, 14, 12, 13, 24],
  ["CZE", 7.250, 13, 10, 10, 10, 7],
  ["DEN", 6.000, 14, 15, 11, 12, 11],
  ["NOR", 5.250, 15, 12, 14, 15, 13],
  ["SRB", 1.400, 16, 18, 18, 30, 46],
  ["UKR", 3.100, 18, 20, 23, 19, 29],
  ["ISR", 5.000, 17, 13, 16, 14, 15],
  ["GRE", 6.400, 19, 19, 17, 22, 9],
  ["POL", 5.625, 20, 17, 15, 11, 12],
  ["CRO", 3.375, 21, 21, 24, 31, 25],
  ["RUS", 4.333, 22, 22, 21, 20, 16],
  ["CYP", 3.500, 23, 23, 25, 21, 22],
  ["SWE", 1.875, 24, 26, 22, 24, 38],
  ["ROU", 3.250, 25, 27, 28, 17, 27],
  ["HUN", 3.500, 26, 24, 26, 18, 22],
  ["SVK", 4.250, 27, 25, 20, 16, 17],
  ["BUL", 2.875, 28, 28, 30, 26, 31],
  ["AZE", 3.625, 29, 29, 27, 25, 19],
  ["MDA", 2.000, 30, 30, 29, 33, 36],
  ["SVN", 3.375, 31, 31, 31, 34, 25],
  ["KVX", 3.000, 32, 32, 33, 32, 30],
  ["KAZ", 3.125, 33, 39, 36, 39, 28],
  ["IRL", 1.500, 34, 33, 35, 36, 42],
  ["FIN", 1.500, 35, 35, 34, 40, 42],
  ["ARM", 2.250, 36, 40, 40, 37, 33],
  ["LVA", 1.625, 37, 37, 37, 38, 41],
  ["FRO", 2.750, 38, 34, 39, 35, 32],
  ["LIE", 0.500, 39, 42, 38, 28, 52],
  ["BIH", 2.000, 40, 38, 42, 42, 36],
  ["ISL", 3.833, 41, 36, 32, 29, 18],
  ["NIR", 1.125, 42, 44, 47, 49, 49],
  ["LUX", 2.250, 43, 47, 45, 44, 33],
  ["LTU", 1.125, 44, 43, 43, 43, 49],
  ["MLT", 1.500, 45, 41, 41, 40, 42],
