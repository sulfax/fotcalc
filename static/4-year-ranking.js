...
function oppdater_ved_refresh() {
  ...
  for (i = 0; i < menyvalg.length; i++) {
    ...
    if (aar_etter_forste_periode == 3) {
      if (er_i_periode_menyvalg_aar_3 != undefined) {er_i_periode_menyvalg = true}
      else  {er_i_periode_menyvalg = false}}
    else {
      if (er_i_periode_menyvalg_aar_3 != undefined || er_i_periode_menyvalg_aar_4 != undefined) {er_i_periode_menyvalg = true}
      else  {er_i_periode_menyvalg = false}}
  ...
  if (aar_etter_forste_periode <= 3) {
    for (i = 0; i < klubb_koeffisienter_1112_2021.length; i++) {
      if (aar_etter_forste_periode == 3) {klubb_i_ranking_periode = (klubb_koeffisienter_1112_2021[i][11])}
...
id = "dropDownMeny";
for (i = 4; i < nyligste_poeng_rangering[0] - 20 + 5; i++) {
