...
function sortFunction_tall_1_flere_desimal(a, b) {
  ...
  if (a[5] == "0.0" && a[6] == "0.0" && a[7] == "0.0" && a[8] == "0.0" && a[9] == "0.0" && a[10] == "0.0" && a[11] == "0.0" && a[12] == "0.0" && a[13] == "0.0" && a[14] == "0.0" && b[5] == "0.0" && b[6] == "0.0" && b[7] == "0.0" && b[8] == "0.0" && b[9] == "0.0" && b[10] == "0.0" && b[11] == "0.0" && b[12] == "0.0" && b[13] == "0.0" && b[14] == "0.0" && a[0] != "" && b[0] != "" && a[1] > b[1]) {return 1}
  if (a[5] == "0.0" && a[6] == "0.0" && a[7] == "0.0" && a[8] == "0.0" && a[9] == "0.0" && a[10] == "0.0" && a[11] == "0.0" && a[12] == "0.0" && a[13] == "0.0" && a[14] == "0.0" && b[5] == "0.0" && b[6] == "0.0" && b[7] == "0.0" && b[8] == "0.0" && b[9] == "0.0" && b[10] == "0.0" && b[11] == "0.0" && b[12] == "0.0" && b[13] == "0.0" && b[14] == "0.0" && a[0] != "" && b[0] != "" && b[1] > a[1]) {return -1}
  if (a[i] == '' || !a[i]) {
    a[i] = 0
  }
