...
function generer_lands_knapper() {
  ...
  for (i = 0; i < landskoeffisienter.length; i++) {
    ...
    //   if (aar_etter_forste_periode == 7) {koeff_sesong6 += 1.666}
    //   if (aar_etter_forste_periode == 8) {koeff_sesong7 += 1.666}
    //   if (aar_etter_forste_periode == 9) {koeff_sesong8 += 1.666}
    //   if (aar_etter_forste_periode == 10) {koeff_sesong9 += 1.666}
    //   if (aar_etter_forste_periode == 11) {koeff_sesong10 += 1.666}}
...
$(window).resize(function() {
  if (vinduBredde >= 2121) {
    if (((window.innerWidth > 0) ? window.innerWidth : screen.width) < 2121) {
  ...
  else if (vinduBredde >= 1899) {
    if (((window.innerWidth > 0) ? window.innerWidth : screen.width) < 1899) {
      for (let i = 0; i < document.getElementsByClassName("reaklame_sidene").length; i++) {
        document.getElementsByClassName("reaklame_sidene")[i].style.display = "none";
      }
    }
