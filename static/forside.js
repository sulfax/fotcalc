...
const penger = [
  ...
  [550000,                        550000],
  [750000,                        750000],
  [[15640000, 3630000, 2940000], [15640000, 3630000, 2940000]],
  [[2800000, 630000, 500000],    [2800000, 630000, 500000]],
  [[930000, 210000, 166000],     [930000, 210000, 166000]],
  [[1137000, 132000, 44500],     [1137000, 132000, 44500]],
...
function generer_lands_knapper() {
  ...
  for (i = 0; i < landskoeffisienter.length; i++) {
    ...
    //   if (aarstall == 4) {koeff_sesong3 = 2.5}
    //   if (aarstall == 5) {koeff_sesong4 = 2.5}
    //   if (aarstall == 6) {koeff_sesong5 = 2.5}}
...
function myFunction() {
  ...
  document.getElementById("ad_venstre").style.top = -3.7*scrolled + "px";
  document.getElementById("ad_hoyre").style.top = -3.7*scrolled + "px";
}
