...
const norsk_koeffisient = [
    ...
    'spoeng til ',
    'Rangering',
    'Den nederste raden beregnes ved å dele assosiasjons-koeffisientpoengene på antallet klubber fra klubbens landet.',
...
const english_forside = [
    ...
    'Contribution',
    'Club points',
    'The "contribution" column is calculated by dividing the association coefficient points by the number of clubs representing the club’s country.',
...
const english_kalkulator = [
    ...
    'Total income:',
    '<p><p>*The calculations do not include resources from the market pool because those depends on these factors:<br><br>1. the actual final amount in the market pool:<br>2. the composition of the field of clubs participating;<br>3. the number of clubs from any given association competing;<br>4. the final position of each competing club in their previous season’s domestic championship;<br>5. the performance of each club in Europe.<br><i>Source: UEFA</i></p>It is therefore impossible to calculate.<br><br>**Calculations do not take the small COVID deduction into consederation.<br><br><br>The calculator is based on <a class="graa_hover_link" id="uefa_distribution_link" href="https://editorial.uefa.com/resources/0277-158b0bea495a-ba6c18158cd3-1000/20220704_circular_2022_47_en.pdf" target="_blank">UEFA’s distribution plan</a>.</p>',
    '<p><p>*The calculations do not include resources from the market pool because those depends on these factors:<br><br>1. the actual final amount in the market pool:<br>2. the composition of the field of clubs participating;<br>3. the number of clubs from any given association competing;<br>4. the final position of each competing club in their previous season’s domestic championship;<br>5. the performance of each club in Europe.<br><i>Source: UEFA</i></p>It is therefore impossible to calculate.<br><br><br>The calculator is based on <a class="graa_hover_link" id="uefa_distribution_link" href="https://editorial.uefa.com/resources/0277-158b0bea495a-ba6c18158cd3-1000/20220704_circular_2022_47_en.pdf" target="_blank">UEFA’s distribution plan</a>.</p>',
...
const english_koeffisient = [
    ...
    '&nbsppoints for ',
    'Ranking',
    'The bottom row is calculated by dividing the association coefficient points by the number of clubs representing the country.',
...
const english_koeffisient_dokumentasjon = [
    ...
    '<span class="bold">Coefficient points</span> are points that all participating clubs in Europe earn each season. The better a club does in Europe, the more coefficient points the club will earn. These points carries multible advantages, both for the club og and the association. A higher coefficient point sum can among others make the road into the groupstages easier for the desired club and for other clubs from their association. <br><br> There are two kinds of coefficient points, association coefficient points og club coefficient points.',
    'Association coefficient points',
    '<span class="bold">Association coefficient points</span> are coefficient points that all clubs in Europe each season earn for their association. For example:<br>',
    'Association coefficient points',
    ...
    'However, there is also something called <span class="bold">"country coefficient"</span>. That is the yearly country coefficient for an association based on the five previous seasons combined.<br>',
    ...
    'We also have a <span class="bold">ranking of associations</span> based on the country coefficient. This ranking decides how many "European spots" each association gets og how easy it is for their clubs to qualify for the group stages. For example:',
    ...
    '<span class="bold">Club coefficient points</span> are points participating clubs in Europe earn for their own club. These points have an impact on among others the club’s seeding in the qualifying rounds and additional prize money in the group stage. A club’s club coefficient points can for example be like this:',
