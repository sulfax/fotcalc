...
const english_kalkulator = [
    ...
    'Eliminated in play-off',
		'<div class="tooltip-container"><u>Undistributed amounts</u><span class="tooltip-content tolltip2">Any residual amount between the overall amount available for the qualifying roundsand the amount distributed to clubs according to the figures from the distribution plan will	be redistributed to clubs participating in the qualifying phase. Will increase if the overall amount available exceeds expectations.</span></div>',
    'Group stage',
