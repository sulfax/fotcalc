...
const english_kalkulator = [
    ...
    'Total income:',
    '<p><p>*The calculations do not include resources from the market pool because those depends on these factors:<br><br>1. the actual final amount in the market pool:<br>2. the composition of the field of clubs participating;<br>3. the number of clubs from any given association competing;<br>4. the final position of each competing club in their previous season’s domestic championship;<br>5. the performance of each club in Europe.<br><i>Source: UEFA</i></p>It is therefore imposible to calculate.<br><br>**Calculations do not take the small covid deduction into consederation. A club’s deduction sum is not very interesting when their money from the marketpool is unknown.<br><br><br>The calculator is based on <a class="graa_hover_link" id="uefa_distribution_link" href="https://editorial.uefa.com/resources/0277-158b0bea495a-ba6c18158cd3-1000/20220704_circular_2022_47_en.pdf" target="_blank">UEFA’s distribution plan</a>.</p>',
