...
const norsk_kalkulator = [
    ...
    'Røk ut i playoff:',
    'Gruppespill:',
    '<abbr data_title="Ti års koeffisient-rangering blant lagene innad i turneringen (1-32). Følg lenke 1 for å finne ut ditt lags rangering">Ti års koeff</abbr>:<a class="graa_hover_link" href="https://www.football-coefficient.eu/money/" target="_blank">1</a><a class="graa_hover_link" href="https://www.uefa.com/nationalassociations/uefarankings/tenyears/" target="_blank">2</a>',
...
const english_kalkulator = [
    ...
    'Group stage:',
    '<abbr data_title="Ten-year coefficient ranking among the clubs within the tournament (1-32). Follow link 1 to find your clubs ranking">Ten-year coeff</abbr>:<a class="graa_hover_link" href="https://www.football-coefficient.eu/money/" target="_blank">1</a><a class="graa_hover_link" href="https://www.uefa.com/nationalassociations/uefarankings/tenyears/" target="_blank">2</a>',
