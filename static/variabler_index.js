...
const norsk = [
    ...
    'Funnet et forbedringspotensiale eller en feil med nettsiden?<br><br>Kontakt meg gjerne på <a id="mailto" href="mailto:johanneskaste@gmail.com?subject=Premiepenger kalkulator">johanneskaste@gmail.com</a>, <a id="twitter_tekst" href="tel:+4747489917">+47 47 48 99 17</a> eller <a id="twitter_tekst" href="https://twitter.com/fotcalc" target="_blank">Twitter</a>',
...
const norsk_forside = [
    ...
    'Premiepenger',
    'Forbundspoeng',
    '<div class="tooltip-container"><u>Bidrag</u><span class="tooltip-content tolltipContributionNorsk">Mer data <a class="linkContribution" href="/country-coefficients#clubs">her</a></span></div>',
    '<div class="tooltip-container"><u>Klubbpoeng</u><span class="tooltip-content tolltipClubPointsNorsk">Mer data<br><a class="linkContribution" href="/club-coefficients">her</a></span></div>',
    'Kolonnen, "bidrag" beregnes ved å dele forbundspoeng-koeffisientpoengene på antallet klubber fra klubbens land.',
    'Tallene i tabellen ovenfor hvis de var fordelt på forbundene:',
    'Premiepenger',
    'Forbundspoeng',
    '<div class="tooltip-container"><u>Bidrag</u><span class="tooltip-content tolltipContributionNorsk">Mer data <a class="linkContribution" href="/country-coefficients">her</a></span></div>',
    'Klubbpoeng',
    'Farget knapp = inkluder',
    'Rød ramme = ekskluder',
    'Avansert filtrering ',
    'Hjemlig seriemester', 'Innledende runde', 'Q1', 'Eliminert i Q1', 'Q2', 'Eliminert i Q2', 'Q3', 'Eliminert i Q3', 'Playoff', 'Eliminert i Playoff', 'Ligaspill', 'Utslagsrunde-playoff', 'Åttedelsfinale', 'Kvartfinale', 'Semifinale', 'Finale', 'Vunnet finale', 'SCUP', 'Vunnet SCUP',
    'Tilbakestill',
];
...
const norsk_ti_års = [
    ...
    'Denne rangeringen benyttes kun til å finne 10-års koeffisient-bonusen (€) til klubbene som deltar i europeiske gruppespill.<br><br><span class="gjennomsiktighet">Rangeringen baseres på <a class="link_utydelig" href="coefficient-definition#club">klubb-koeffisientpoeng</a>. Se også <a class="link_utydelig" href="club-coefficients">5-års koeffisient-rangeringen</a>.</span>',
		'Denne rangeringen benyttes kun til å finne 10-års koeffisient-bonusen (€) til klubbene som deltar i europeiske ligaspill.<br><br><span class="gjennomsiktighet">Rangeringen baseres på <a class="link_utydelig" href="coefficient-definition#club">klubb-koeffisientpoeng</a>. Se også <a class="link_utydelig" href="club-coefficients">5-års koeffisient-rangeringen</a>.</span>',
    'Avgjørende for gruppespills-bonus (€) i ',
		'Avgjørende for ligaspill-bonus (€) i ',
    'Klubber med blå bakgrunnsfarge konkurrerer fortsatt. Klubber med grønn bakgrunnsfarge er fra aktive nasjoner.',
    'UEFA bruker det tallet som er størst av klubbens totale koeffisientpoeng (oppført under "Points" i tabellen), og 20% av landets koeffisientpoeng (oppført under "NA").',
...
const norsk_kalkulator = [
    ...
    'Kalkuler din klubbs inntekter i UEFA turneringer. Kalkulasjonene innkluderer alle kalkulerbare premiepenger og ufordelte ressurser.',
		'Kalkuler din klubbs inntekter i UEFA turneringer. Kalkulasjonene innkluderer alle premiepenger og ufordelte ressurser.',
    'Klubbens<br>progresjon? <br> <img src="media/reshot-icon-arrow-down-QUF8YZRG63.svg" alt="arrow pointing downwards">',
    'Hjemlig seriemester',
    ...
    'Playoff',
    'Røk ut i playoff',
		'<div class="tooltip-container"><u>Ufordelte ressurser</u><span class="tooltip-content tolltip3">Alle penger øremerket kvalifiseringsrundene blir ikke fordelt slik det er tiltenkt i den økonomiske fordelingsplanen. Restbeløpet utbetales proporsjonalt til klubbene som har deltatt i kvalifiseringen. Beløpet øker hvis UEFAs inntekter overstiger forventningene.</span></div>',
    'Gruppespill',
    '<div class="tekst_margin_hoyre"><abbr data_title="Tiårs koeffisient-rangering internt i gruppespillet (1-32). Følg lenke 2 for å finne ut.">Tiårs-rangering</abbr>: </div> <a class="graa_hover_link" href="10-year-ranking" onclick="endre_ti_års_periode()" target="_blank"><abbr data_title="Tiårs koeffisient-rangering">1</abbr></a>',
		'<div class="tooltip-container"><u>Medieverdi-rangering</u><span class="tooltip-content tolltip4">I denne rangeringen okkuperer klubbene posisjonene som er garantert av deres lands landsrangering. For eksempel, hvis landet som er rangert som nummer 1 i medieverdi har fire klubber i turneringen, vil klubbene fra det landet bli rangert fra 1 til 4 på medieverdi-rangeringen. Rekkefølgen på rangeringene til disse fire klubbene fra 1 til 4 vil være basert på deres deltakelse i hovedfasene i UEFAs klubbturneringer de siste fem sesongene (3 poeng for en sesong i UCL, 2 poeng for en sesong i UEL, 1 poeng for en sesong i UECL). Samme prosedyre gjelder alle land og deres klubber ned til rangering 36.</span></div>',
    ...
    'Inntjening per turnering',
		'<abbr data_title="Del av overskudd av konkurransens bruttoinntekt, og det potensielle proporsjonale COVID-19-fradraget">Endelig balanse</abbr>',
		'<abbr data_title="Del av overskudd av konkurransens bruttoinntekt">Endelig balanse</abbr>',
    'Total inntjening',
    'Kalkulatoren er basert på <a class="graa_hover_link" id="uefa_distribution_link" href="https://editorial.uefa.com/resources/0283-1874e21d8957-30a439a30e08-1000/20230707_circular_2023_35_en.pdf" target="_blank">UEFAs distribusjonsplan</a>.',
    ...
    'Ligaspill',
		'<div class="tooltip-container"><u>Europeisk del %</u><span class="tooltip-content">Andel penger fra "verdi-kolonnen" som går til den "europeiske delen" (medieverdi-rangering og femårs-rangering). 75% er forventet, men ikke bekreftet. Resten går til den "ikke-europeiske delen" (tiårs-rangering).</span></div>',
    'Ligaplassering',
    '<div class="tekst_margin_hoyre"><div class="tooltip-container"><u>Tiårs-rangering</u><span class="tooltip-content">Tiårs koeffisient-rangering internt i ligaspillet (1-36). Pengene vedrørende denne rangeringen kommer fra den ikke-europeiske delen. Følg lenke 2 for å se rangeringen.</span></div></div><a class="graa_hover_link" href="10-year-ranking" onclick="endre_ti_års_periode()" target="_blank"><abbr data_title="Ten-year coefficient ranking">2</abbr></a>',
		'<div class="tekst_margin_hoyre"><abbr data_title="Femårs koeffisient-rangering internt i ligaspillet (1-36). Følg lenke 1 for å finne ut.">Femårs-rang.</abbr></div><a class="graa_hover_link" href="club-coefficients" onclick="endre_fem_års_periode()" target="_blank"><abbr data_title="Klubbkoeffisient-rangering">1</abbr></a>',
		'<div class="tooltip-container"><u>Europeisk del-rang.</u><span class="tooltip-content tolltip5">Klubbens totalrangering vedrørende den europeiske delen (1-36) blir bestemt av gjennomsnittet av rangeringspoengene som klubben har i medieverdi-rangering og femårs-rangering (jo færre poeng, jo høyere rangering). For eksempel vil en klubb som er på 4. plass på medieverdi-rangeringen og 6. plass på femårs-rangeringen, i gjennomsnitt ha fem poeng i den kumulative totalrangeringen og blir rangert deretter.</span></div>',
		'(poeng: ',
...
const norsk_koeffisient = [
    ...
    'UEFA Koeffisient-kalkulator',
    'Kalkuler forbunds- og klubb-<a class="graa_hover_link_koeff_deffi" href="coefficient-definition">koeffisientpoeng</a> for din klubb.',
    'Klubbens<br>progresjon? <br> <img src="media/reshot-icon-arrow-down-QUF8YZRG63.svg" alt="arrow pointing downwards">',
    ...
    'Åttedelsfinale',
    'Åttedelsfinale | kamp 1',
    'Åttedelsfinale | kamp 2',
    'Kvartfinale',
    'Kvartfinale | kamp 1',
    'Kvartfinale | kamp 2',
    'Semifinale',
    ...
    '*Kalkulatoren er basert på <a class="graa_hover_link" id="uefa_distribution_link" href="https://documents.uefa.com/r/Regulations-of-the-UEFA-Champions-League-2023/24/Annex-D-Coefficient-Ranking-System-Online" target="_blank">UEFAs koeffisient-rangeringssystem</a>.',
		'*Kalkulatoren er basert på <a class="graa_hover_link" id="uefa_distribution_link" href="https://documents.uefa.com/r/Regulations-of-the-UEFA-Champions-League-2024/25/Annex-D-Coefficient-Ranking-System-Online" target="_blank">UEFAs koeffisient-rangeringssystem</a>.',
...
const norsk_koeffisient_dokumentasjon = [
    ...
    '<span class="bold">Koeffisientpoeng</span> er poeng som alle deltakende klubber i Europa er med på å samle inn hver sesong. Jo bedre en klubb gjør det i Europa, jo flere koeffisientpoeng vil klubben tjene. Disse poengene har flere fordeler, både for klubben og forbundet. Blant annet kan en høyere koeffisientpoengsum sørge for at veien til et gruppespill blir lettere for den aktuelle klubben og for andre klubber fra deres forbund. <br><br> Det finnes to typer koeffisientpoeng, forbunds-koeffisientpoeng og klubb-koeffisientpoeng.',
    'Forbunds-koeffisientpoeng',
    '<span class="bold">Forbundspoeng</span> er poeng som klubber i Europa hver sesong tjener inn til sitt forbund, eksempelvis:<br>',
    'Forbundspoeng',
    ...
    '(Verdiene refererer til forbundspoeng som regnes ut med kalkulatoren)',
    'Den <span class="bold">"årlige landskoeffisienten"</span> til forbundet er den totale mengden poeng delt på antall lag. I dette tilfellet er det 30,5 poeng delt på fire lag:<br>',
    '<thead class="thead-light"><tr class="head_tr"><th scope="col"></th><th scope="col"><span class="italic">Årlig landskoeffisient (2021/22)</span></th></tr></thead><tbody><tr><th scope="row"><span class="italic">Norge</span></th><td class="sentrert_tall"><span class="italic">7,625</span></td></tr></tbody>',
    '<span class="bold">"Landskoeffisienten"</span> til et land tilsvarer summen av de fem siste sesongenes årlige landskoeffisient. Den årlige landskoeffisienten til Norge var 4.000, 5,375, 3,750, 6.500 og 7,625 i henholdsvis sesongene 2017/18 - 2021/22. Landskoeffisienten vår i 2021/22-sesongen endte derfor på totalt 27,250:<br>',
    '<thead class="thead-light"><tr class="head_tr"><th scope="col"></th><th scope="col"><span class="italic">Landskoeffisient (2021/22)</span></th></tr></thead><tbody><tr><th scope="row"><span class="italic">Norge</span></th><td class="sentrert_tall"><span class="italic">27,250</span></td></tr></tbody>',
    '(Landskoeffisientpoeng fra 17/18 - 2021/22)',
    'Landskoeffisienten brukes til å danne en <span class="bold">rangering av forbund</span>. Denne rangeringen bestemmer hvor mange Europa-plasser hvert forbund får og hvor lang vei klubbene har til gruppespill, eksempelvis:',
    '<thead class="thead-light"><tr class="head_tr"><th scope="col"></th><th scope="col"><span class="italic"><a class="graa_hover_link_tabell_header" href="country-coefficients" onclick="trykker_lands_rank_deffinisjon()">Landskoeffisient-rangering</a> (2021/22)</span></th><th scope="col"><span class="italic">Europa-plasser (2023/24)</span></th></tr></thead><tbody><tr><th scope="row" class="sentrert_vertikalt_tall"><span class="italic">Norge</span></th><td class="sentrert_tall sentrert_vertikalt_tall"><span class="italic">17</span></td><td><span class="italic">UCL kvalikk: 1 klubb<br> UECL kvalikk: 3 klubber</span></td></tr></tbody>',
    'Klubb-koeffisientpoeng',
    '<span class="bold">Klubb-koeffisientpoeng</span> er poeng deltakende klubber i Europa samler inn til egen klubb. Disse poengene har innvirkning på blant annet klubbens seeding i kvalikken og ekstra premiepenger i gruppespill. Disse poengene er ikke helt identiske med forbundspoengene. Mens Bodø/Glimt fikk 23,5 forbundspoeng i 2021/22-sesongen, fikk de kun 15 klubb-koeffisientpoeng:',
...
const english = [
    ...
    'Found potential for improvement, a bug or something wrong with the website?<br><br>You are welcome to contact me on <a id="mailto" href="mailto:johanneskaste@gmail.com?subject=Fotcalc">johanneskaste@gmail.com</a>, <a id="twitter_tekst" href="tel:+4747489917">+47 47 48 99 17</a> or <a id="twitter_tekst" href="https://twitter.com/fotcalc" target="_blank">Twitter/X</a>',
    '<abbr data_title="England"><img class="flagg" src="media/UEFA/ENG.svg"></abbr>',
...
const english_forside = [
    ...
    'Prize money',
    'Association points',
    '<div class="tooltip-container"><u>Contribution</u><span class="tooltip-content tolltipContribution">More data <a class="linkContribution" href="/country-coefficients#clubs">here</a></span></div>',
    '<div class="tooltip-container"><u>Club points</u><span class="tooltip-content tolltipClubPoints">More data<br><a class="linkContribution" href="/club-coefficients">here</a></span></div>',
    ...
    'Prize money',
    'Association points',
    '<div class="tooltip-container"><u>Contribution</u><span class="tooltip-content tolltipContribution">More data <a class="linkContribution" href="/country-coefficients">here</a></span></div>',
    'Club points',
    'Colored button = include',
    'Red border = exclude',
    'Advanced filtering ',
    'Domestic Champion', 'Preliminary round', 'Q1', 'Eliminated in Q1', 'Q2', 'Eliminated in Q2', 'Q3', 'Eliminated in Q3', 'Play-off', 'Eliminated in play-off', 'League phase', 'Knockout round play-off', 'Round of 16', 'Quarter-final', 'Semi-final', 'Final', 'Champion', 'SCUP', 'Champion',
    'Reset',
];
...
const english_klubbkoeffisient = [
    ...
    'Club coefficient ranking',
    'This UEFA 5-year ranking decides seeding and pot-distribution in qualifying rounds and the group stage. A higher ranking gives the club weaker opponents in the mentioned phases.<br><br><span class="gjennomsiktighet">The ranking is based on <a class="link_utydelig" href="coefficient-definition#club">club coefficient points</a>. See also the <a class="link_utydelig" href="10-year-ranking">10-year coefficient ranking</a>.</span>',
...
const english_ti_års = [
    ...
    "This ranking is used solely to find the clubs' 10-year coefficient bonus (€) for participating in European group stages.<br><br><span class='gjennomsiktighet'>The ranking is based on <a class='link_utydelig' href='coefficient-definition#club'>club coefficient points</a>. See also the <a class='link_utydelig' href='club-coefficients'>5-year coefficient ranking</a>.</span>",
		"This ranking is used solely to find the clubs' 10-year coefficient bonus (€) for participating in European league phases.<br><br><span class='gjennomsiktighet'>The ranking is based on <a class='link_utydelig' href='coefficient-definition#club'>club coefficient points</a>. See also the <a class='link_utydelig' href='club-coefficients'>5-year coefficient ranking</a>.</span>",
    'Decisive for group stage bonus (€) for ',
		'Decisive for league phase bonus (€) for ',
    'Clubs with a blue background color are still in competition. Clubs with a green background color are from active countries.',
    `UEFA will use whichever number is higher between a club's total coefficient points (listed under "Points" in the table), or 20% of the national association's coefficient points (listed under "NA").`,
...
const english_kalkulator = [
    ...
    "Calculate your club's income and revenue distribution in UEFA competitions. Calculations include all exact prize money sums and undistributed amounts.",
		"Calculate your club's income and revenue distribution in UEFA competitions. Calculations include all prize money sums and undistributed amounts, including the full value pillar (the European and non-European part).",
    `Club's<br>progression? <br> <img src="media/reshot-icon-arrow-down-QUF8YZRG63.svg" alt="arrow pointing downwards">`,
    'Domestic champion',
    '<abbr data_title="Preliminary round before the qualification itself">Preliminary round</abbr>',
    ...
    'Eliminated in play-off',
		'<div class="tooltip-container"><u>Undistributed amounts</u><span class="tooltip-content tolltip2">Any residual amount between the overall amount available for the qualifying rounds and the amount distributed to clubs according to the figures from the distribution plan will	be redistributed to clubs participating in the qualifying phase. Will increase if the overall amount available exceeds expectations.</span></div>',
    'Group stage',
    '<div class="tekst_margin_hoyre"><abbr data_title="Ten-year coefficient rank internally in the group stage (1-32). Follow link 1 to figure out.">Ten-year rank</abbr> </div> <a class="graa_hover_link" href="10-year-ranking" onclick="endre_ti_års_periode()" target="_blank"><abbr data_title="Ten-year coefficient ranking">1</abbr></a>',
		'<div class="tooltip-container"><u>Market value rank</u><span class="tooltip-content tolltip4">In this ranking, the clubs occupy the ranks guaranteed by their country ranking. For example, if the country ranked number 1 in the media market value ranking has four clubs in the competition, the clubs of that country will be ranked from 1 to 4 in the market value ranking. The order of these four clubs from 1 to 4 will be based on their participation in the group phase of the UEFA club competitions over the previous five seasons (3 points for a season in UCL, 2 points for a season in UEL, 1 point for a season in UECL). The same procedure will apply to all countries and their clubs down to rank 36.</span></div>',
    '<abbr data_title="Amount of wins in the group stage">Wins</abbr>',
    '<abbr data_title="Amount of draws in the group stage">Draws</abbr>',
    `<abbr data_title="Total number of drawn games in the competition's groups (0-96)">Total draws</abbr>`,
    '<abbr data_title="Redistributed amounts remaining from the matches ending in a draw in the group stage">Undistributed amounts</abbr>',
		`<div class="tooltip-container"><u>Undistributed amounts</u><span class="tooltip-content">Redistributed amounts remaining from the matches ending in a draw in the league phase. These amounts are distributed proportionally based on league placement.</span></div>`,
    'Group placement',
    '<abbr data_title="Knockout play-off for the knockout rounds">KO round play-off</abbr>',
    'Round of 16',
    'Quarter-final',
    'Semi-final',
    'Final',
    ...
    'Income per competition',
		'<abbr data_title="Share of surplus in competition gross revenue, and the potential pro rata COVID-19 deduction">Final balance</abbr>',
		'<abbr data_title="Share of surplus in competition gross revenue">Final balance</abbr>',
    'Total income',
    `The calculator is based on <a class="graa_hover_link" id="uefa_distribution_link" href="https://editorial.uefa.com/resources/0283-1874e21d8957-30a439a30e08-1000/20230707_circular_2023_35_en.pdf" target="_blank">UEFA's distribution plan</a>.`,
    ...
    'League phase',
		'<div class="tooltip-container"><u>European part %</u><span class="tooltip-content">% of money from the "value pillar" that goes to the "European part" (market value rank and five-year rank). 75% is expected, but not confirmed. The rest is for the "non-European part" (ten-year rank).</span></div>',
    'League placement',
    '<div class="tekst_margin_hoyre"><div class="tooltip-container"><u>Ten-year rank</u><span class="tooltip-content">Ten-year coefficient rank internally in the	league phase (1-36). The money from this rank comes from the non-European part.	Follow link 2 to figure out.</span></div></div><a class="graa_hover_link" href="10-year-ranking" onclick="endre_ti_års_periode()" target="_blank"><abbr data_title="Ten-year coefficient ranking">2</abbr></a>',
		'<div class="tekst_margin_hoyre"><abbr data_title="Club coefficient rank internally in the league phase (1-36). Follow link 1 to figure out.">Five-year rank</abbr></div><a class="graa_hover_link" href="club-coefficients" onclick="endre_fem_års_periode()" target="_blank"><abbr data_title="Club coefficient ranking">1</abbr></a>',
		'<div class="tooltip-container"><u>European part rank</u><span class="tooltip-content tolltip5">The European part rank (1-36) is determined by the average number of ranking points totalled by the club in the market value ranking and the five-year ranking (the less points, the higher the rank). For example, a club 4th in the market value ranking and 6th in the five-year ranking would have an average of five points in the cumulative ranking and will be ranked accordingly.</span></div>',
		'(points: ',
...
const english_koeffisient = [
    ...
    `Club's<br>progression? <br> <img src="media/reshot-icon-arrow-down-QUF8YZRG63.svg" alt="arrow pointing downwards">`,
    '<abbr data_title="Preliminary round before the qualification itself">PR</abbr> | semi-final',
    'PR | final',
    ...
    'Group placement',
    'League placement',
    '<abbr data_title="Knockout play-off for the knockout rounds">KO round play-off</abbr> | match 1',
    'KO round play-off | match 2',
    'Round of 16',
    'Round of 16 | match 1',
    'Round of 16 | match 2',
    'Quarter-final',
...
const english_koeffisient_dokumentasjon = [
    ...
    '(Section from the third qualifying round for the Champions League 2021/22)',
