...
const norsk_forside = [
    ...
    'Tallene i tabellen ovenfor fordelt på forbundene:',
    'Premiepenger',
    'Forbundspoeng',
    'Bidrag',
    'Klubbpoeng',
...
const norsk_koeffisient = [
    ...
    'UEFA Koeffisient-kalkulator',
    'Kalkuler klubb- og forbunds-<a class="graa_hover_link_koeff_deffi" href="coefficient-definition">koeffisientpoeng</a> for din klubb.',
    '<br> Klubbens<br>progresjon? <br> <img src="media/reshot-icon-arrow-down-QUF8YZRG63.svg" alt="arrow pointing downwards">',
