...
var UCL_deltagelsespenger_2122 = UCL_total_mengde_2122 * .25;
var UEL_deltagelsespenger_2122 = UEL_total_mengde_2122 * 0.25;
var UECL_deltagelsespenger_2122 = UECL_total_mengde_2122 * 0.40;
var UCL_ti_års_koeffisient_rangering_2122 = UCL_total_mengde_2122 * .30;
var UEL_ti_års_koeffisient_rangering_2122 = UEL_total_mengde_2122 * .15;
var UECL_ti_års_koeffisient_rangering_2122 = UECL_total_mengde_2122 * .10;
...
/*Variabler som skal brukes i utregninger under*/
/*22/23 variabler til utregning av noen summer*/
var UCL_total_mengde_2223 = 2032000000;
var UEL_total_mengde_2223 = 565000000; 
var UECL_total_mengde_2223 = 245000000;
var UCL_utslåtte_lagene_PO_2223 = 35000000;
var UCL_deltagelsespenger_2223 = UCL_total_mengde_2223 * .25;
var UEL_deltagelsespenger_2223 = UEL_total_mengde_2223 * 0.25;
var UECL_deltagelsespenger_2223 = UECL_total_mengde_2223 * 0.40;
var UCL_ti_års_koeffisient_rangering_2223 = UCL_total_mengde_2223 * .30;
var UEL_ti_års_koeffisient_rangering_2223 = UEL_total_mengde_2223 * .15;
var UECL_ti_års_koeffisient_rangering_2223 = UECL_total_mengde_2223 * .10;
var UCL_antall_deltagere_2223 = 32;
var UEL_antall_deltagere_2223 = 32;
var UECL_antall_deltagere_2223 = 32;
var UCL_antall_deler_2223 = 528;
var UEL_antall_deler_2223 = 528;
var UECL_antall_deler_2223 = 528;
var Spilt_SCUP_total_2223 = 8000000;
/*Premiepenger ved ulike situasjoner uavhengig av turnering*/
/*21/22 knapper*/
var Hjemlig_seriemester_2223 = 290000;
var Spilt_Pre_Q_eller_PO_2223 = 150000;
var UECL_Slått_ut_Q1_2223 = 200000;
var UECL_Slått_ut_Q2_2223 = 400000;
var UECL_Slått_ut_Q3_2223 = 800000;
var Spilt_Q3_league_path_2223 = "";
var UCL_utslått_lag_PO_2223 = UCL_utslåtte_lagene_PO_2223 / 6;
var UECL_Slått_ut_PO_2223 = 900000;
var UCL_deltaker_gruppespillet_2223 = UCL_deltagelsespenger_2223 / UCL_antall_deltagere_2223;
var UEL_deltaker_gruppespillet_2223 = UEL_deltagelsespenger_2223 / UEL_antall_deltagere_2223;
var UECL_deltaker_gruppespillet_2223 = UECL_deltagelsespenger_2223 / UECL_antall_deltagere_2223;
var UCL_spilt_åttendedelsfinale_2223 = 12000000;
var UEL_spilt_åttendedelsfinale_2223 = 1500000;
var UECL_spilt_åttendedelsfinale_2223 = 800000;
var UCL_spilt_kvartfinale_2223 = 12600000;
var UEL_spilt_kvartfinale_2223 = 2000000;
var UECL_spilt_kvartfinale_2223 = 1400000;
var UCL_spilt_semifinale_2223 = 15500000;
var UEL_spilt_semifinale_2223 = 3100000;
var UECL_spilt_semifinale_2223 = 2300000;
var UCL_spilt_finale_2223 = 18500000;
var UEL_spilt_finale_2223 = 4900000;
var UECL_spilt_finale_2223 = 3300000;
var UCL_vinner_2223 = 4800000;
var UEL_vinner_2223 = 4300000;
var UECL_vinner_2223 = 2300000;
...
var UCL_uavgjort_2223 = 980000;
var UEL_uavgjort_2223 = 230000;
var UECL_uavgjort_2223 = 196000;
var påfyll_ingen_funksjon_2223 = 0;
var UEL_førsteplass_2223 = 1400000;
var UECL_førsteplass_2223 = 680000;
var UEL_andreplass_2223 = 580000; 
var UECL_andreplass_2223 = 345000;
var UEL_spilt_utslagsrunde_PO_2223 = 540000;
...
const UECL_inntjening_celler = ["b4_", "b5_", "b7_", "b8_", "b11_", "b12_", "b15_", "b17_", "b20_", "b23_", "b26_", "b29_", "b32_", "b35_", "i6_", "i9_", "i15_", "i15__"];
const seriemester_inntjening_celler = ["b1_"];

const UECL_fjerning_av_summer_ved_deltagelse = ["b1_", "b5_", "b8_", "b12_", "b17_"];

var UCL_ikke_avrundet_ti_års_koeff = 0;
var UEL_ikke_avrundet_ti_års_koeff = 0;
var UECL_ikke_avrundet_ti_års_koeff = 0;

var UCL_ikke_avrundet_ufordelte_ressurser = 0;
var UEL_ikke_avrundet_ufordelte_ressurser = 0;
...
function forlat_input_felt_1(clicked_id) {
    ...
    if (document.getElementById(clicked_id).value != "") {
        if (input_felt_verdi >= 1 && input_felt_verdi <= antall_deltagere[nummer_2 - 1]) {
            ...
            document.getElementById(clicked_id + "_").innerText = "€ " + aktuell_sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ");
            if (nummer_2 == 1) {
                UCL_ikke_avrundet_ti_års_koeff = aktuell_sum;
            }
            if (nummer_2 == 2) {
                UEL_ikke_avrundet_ti_års_koeff = aktuell_sum;
            }
            if (nummer_2 == 3) {
                UECL_ikke_avrundet_ti_års_koeff = aktuell_sum;
            }
            summer();
            rund_av_enkeltcelle(aktuell_sum, clicked_id);
        }
            ...
            if (nummer_2 == 1) {
                UCL_ikke_avrundet_ti_års_koeff = 0;
            }
            if (nummer_2 == 2) {
                UEL_ikke_avrundet_ti_års_koeff = 0;
            }
            if (nummer_2 == 3) {
                UECL_ikke_avrundet_ti_års_koeff = 0;
            }
...
function forlat_input_felt_3(clicked_id) {
    ...
    if (document.getElementById(clicked_id).value != "") {
        ...
        if ((totalt_antall_uavgjorte_kamper >= (antall_uavgjorte_kamper)) && ((totalt_antall_uavgjorte_kamper <= (96 - (6 - (antall_uavgjorte_kamper)) || 96)))) {
            ...
            if (nummer_2 == 10) {
                UCL_ikke_avrundet_ufordelte_ressurser = 0;
            }
            if (nummer_2 == 11) {
                UEL_ikke_avrundet_ufordelte_ressurser = 0;
            }
            if (nummer_2 == 12) {
                UECL_ikke_avrundet_ufordelte_ressurser = 0;
            }
            utenfor_gyldig_input(clicked_id);
            summer();
        }
...
function summer() {
    ...
    var UCL_faktisk_total_sum = parseFloat(UCL_total_sum) + parseFloat(UCL_ikke_avrundet_ti_års_koeff) + parseFloat(UCL_ikke_avrundet_ufordelte_ressurser);
    var UEL_faktisk_total_sum = parseFloat(UEL_total_sum) + parseFloat(UEL_ikke_avrundet_ti_års_koeff) + parseFloat(UEL_ikke_avrundet_ufordelte_ressurser);
    var UECL_faktisk_total_sum = parseFloat(UECL_total_sum) + parseFloat(UECL_ikke_avrundet_ti_års_koeff) + parseFloat(UECL_ikke_avrundet_ufordelte_ressurser);
