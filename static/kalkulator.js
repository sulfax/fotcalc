...
const UCL_inntjening_celler = ["b2_", "b3_", "b6_", "b9_", "b13_", "b16_", "b21_", "b24_", "b27_", "b30_", "b33_", "i4_", "i7_"]; /*Ikke i1, i2, i3, i10, i11 og i12 fordi de verdiene hentes fra de "ikke avrundede" listene*/
const UEL_inntjening_celler = ["b10_", "b14_", "b22_", "b25_", "b28_", "b31_", "b34_", "i5_", "i8_", "i14_", "i14__"];
...
document.getElementById('reklame_sidene').appendChild(div);


const div2 = document.createElement("div");
div2.id = "reklame_hoyre";
...
document.getElementById('reklame_sidene').appendChild(div2);


const widthOutput = document.querySelector('body');


/* Endre synlighet reklame (sidene) */
reportWindowSize()
function reportWindowSize() {
    if (window.innerWidth >= 1870) {
        document.getElementById('reklame_venstre').style.display = "block";
        document.getElementById('reklame_hoyre').style.display = "block";
    }
    else {
        document.getElementById('reklame_venstre').style.display = "none";
        document.getElementById('reklame_hoyre').style.display = "none";
    }
}
